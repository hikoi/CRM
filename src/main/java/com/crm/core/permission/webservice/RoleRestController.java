...
public class RoleRestController{
    ...
    public Responsed<Page<Role>> page(Long pageNum, Long pageSize, String id, String name, UsingState state){
        PageRequest pageRequest = new PageRequest(pageNum, pageSize);
        Page<Role> page = roleService.page(pageRequest, id, name, state);
