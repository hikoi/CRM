...
public class UpYunTest {
     ...
     * @return UpYun object
     */
    public UpYunTest(String bucketName, String userName, String password) {
    ...
    public boolean writeFile(String filePath, byte[] datas) {
        return writeFile(filePath, datas, true, null);
    }
...
System.out.println(datas.length);
    ...
    public boolean writerFile(String filePath, InputStream inputStream, boolean auto, Map<String, String> params) throws IOException {
        ...
        try {
            ...
            conn.setRequestProperty(AUTHORIZATION,
                    sign(conn, filePath, inputStream.available()));
    ...
    private String HttpAction(String method, String uri, byte[] datas,
        ...
        try {
            ...
            if (datas != null) {
                os = conn.getOutputStream();
                System.out.println("aaaaa: " + datas.length);
                os.write(datas);
                os.flush();
            }
...
//            }
    ...
    public enum PARAMS {
         ...
         *
         * @see {@link 'http://wiki.upyun.com/index.php?title=缩略图方式差别举例'}
         */
         ...
         *
         * @see {@linkplain 'http://wiki.upyun.com/index.php?title=如何创建自定义缩略图'}
         */
         ...
         *
         * @see {@link 'http://wiki.upyun.com/index.php?title=图片旋转'}
         */
         ...
         * > 0
         *
         * @see {@link 'http://wiki.upyun.com/index.php?title=图片裁剪'}
         */
